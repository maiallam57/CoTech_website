...
const search = document.querySelector('.studentInput-group input'),
...
const isLeapYear = (year) => {
  ...
  // report page
// fliter bar
const selectBtn = document.querySelector(".searchselect-btn")
 Items = document.querySelector(".reportItem")
